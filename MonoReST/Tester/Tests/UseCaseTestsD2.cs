...
namespace Emc.Documentum.Rest.Test
{
    ...
    public class UseCaseTestsD2 : UseCaseTests, IDisposable
    {
            ...
            try
            {
                ...
                switch (testName)
                {
                    ...
                    case "GetDocumentForView":
                        ...
                        {
                            ViewDocument(primaryContentDirectoryName, MoveDocs[p], openEachFile);
                        }
        ...
        protected new D2Repository CurrentRepository { get; set; }

        protected override Repository GetCurrentRepository(HomeDocument homeDoc, string repository) 
        {
            return homeDoc.GetRepository<D2Repository>(repositoryName);
        }
